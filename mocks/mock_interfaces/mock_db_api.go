...
// Source: shared/storage/interfaces/db_api_interface.go
...
func (m *MockDBInterface) GetUsers(page, rowsNum int) (models.TableUsers, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUsers", page, rowsNum)
	ret0, _ := ret[0].(models.TableUsers)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockDBInterface) GetLangs() (models.Langs, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLangs")
	ret0, _ := ret[0].(models.Langs)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockDBInterface) GetCards(dictId, page, rowsNum int) (models.Cards, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCards", dictId, page, rowsNum)
	ret0, _ := ret[0].(models.Cards)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockDBInterface) SetCardToDictionary(userId, dictID int, card models.Card) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetCardToDictionary", userId, dictID, card)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetCardToDictionary indicates an expected call of SetCardToDictionary
func (mr *MockDBInterfaceMockRecorder) SetCardToDictionary(userId, dictID, card interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetCardToDictionary", reflect.TypeOf((*MockDBInterface)(nil).SetCardToDictionary), userId, dictID, card)
}

// DeleteCardInDictionary mocks base method
func (m *MockDBInterface) DeleteCardInDictionary(userId, cardID, dictionaryID int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCardInDictionary", userId, cardID, dictionaryID)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteCardInDictionary indicates an expected call of DeleteCardInDictionary
func (mr *MockDBInterfaceMockRecorder) DeleteCardInDictionary(userId, cardID, dictionaryID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCardInDictionary", reflect.TypeOf((*MockDBInterface)(nil).DeleteCardInDictionary), userId, cardID, dictionaryID)
}

// GetCardsForGame mocks base method
func (m *MockDBInterface) GetCardsForGame(dictId, cardsNum int) (models.GameWords, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCardsForGame", dictId, cardsNum)
	ret0, _ := ret[0].(models.GameWords)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockDBInterface) GetDicts(userId, page, rowsNum int) (models.DictInfos, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDicts", userId, page, rowsNum)
	ret0, _ := ret[0].(models.DictInfos)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockDBInterface) FillDictionaryFromXLSX(userId, dictId int, pathToFile string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FillDictionaryFromXLSX", userId, dictId, pathToFile)
	ret0, _ := ret[0].(error)
	return ret0
}

// FillDictionaryFromXLSX indicates an expected call of FillDictionaryFromXLSX
func (mr *MockDBInterfaceMockRecorder) FillDictionaryFromXLSX(userId, dictId, pathToFile interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FillDictionaryFromXLSX", reflect.TypeOf((*MockDBInterface)(nil).FillDictionaryFromXLSX), userId, dictId, pathToFile)
}
...
// GetCards mocks base method
func (m *MockCardManager) GetCards(dictId, page, rowsNum int) (models.Cards, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCards", dictId, page, rowsNum)
	ret0, _ := ret[0].(models.Cards)
	ret1, _ := ret[1].(bool)
...
// SetCardToDictionary mocks base method
func (m *MockCardManager) SetCardToDictionary(userId, dictID int, card models.Card) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetCardToDictionary", userId, dictID, card)
	ret0, _ := ret[0].(error)
	return ret0
...
// SetCardToDictionary indicates an expected call of SetCardToDictionary
func (mr *MockCardManagerMockRecorder) SetCardToDictionary(userId, dictID, card interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetCardToDictionary", reflect.TypeOf((*MockCardManager)(nil).SetCardToDictionary), userId, dictID, card)
}

// DeleteCardInDictionary mocks base method
func (m *MockCardManager) DeleteCardInDictionary(userId, cardID, dictionaryID int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCardInDictionary", userId, cardID, dictionaryID)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteCardInDictionary indicates an expected call of DeleteCardInDictionary
func (mr *MockCardManagerMockRecorder) DeleteCardInDictionary(userId, cardID, dictionaryID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCardInDictionary", reflect.TypeOf((*MockCardManager)(nil).DeleteCardInDictionary), userId, cardID, dictionaryID)
}

// GetCardsForGame mocks base method
func (m *MockCardManager) GetCardsForGame(dictId, cardsNum int) (models.GameWords, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCardsForGame", dictId, cardsNum)
	ret0, _ := ret[0].(models.GameWords)
	ret1, _ := ret[1].(bool)
...
// GetDicts mocks base method
func (m *MockDictionaryManager) GetDicts(userId, page, rowsNum int) (models.DictInfos, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDicts", userId, page, rowsNum)
	ret0, _ := ret[0].(models.DictInfos)
	ret1, _ := ret[1].(bool)
...
// FillDictionaryFromXLSX mocks base method
func (m *MockDictionaryManager) FillDictionaryFromXLSX(userId, dictId int, pathToFile string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FillDictionaryFromXLSX", userId, dictId, pathToFile)
	ret0, _ := ret[0].(error)
	return ret0
...
// FillDictionaryFromXLSX indicates an expected call of FillDictionaryFromXLSX
func (mr *MockDictionaryManagerMockRecorder) FillDictionaryFromXLSX(userId, dictId, pathToFile interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FillDictionaryFromXLSX", reflect.TypeOf((*MockDictionaryManager)(nil).FillDictionaryFromXLSX), userId, dictId, pathToFile)
}
...
// GetLangs mocks base method
func (m *MockLanguageManager) GetLangs() (models.Langs, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLangs")
	ret0, _ := ret[0].(models.Langs)
	ret1, _ := ret[1].(bool)
...
// GetUsers mocks base method
func (m *MockUserManager) GetUsers(page, rowsNum int) (models.TableUsers, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUsers", page, rowsNum)
	ret0, _ := ret[0].(models.TableUsers)
	ret1, _ := ret[1].(bool)
