...
// IncUserLastID mocks base method
func (m *MockUserManager) IncUserLastID() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "IncUserLastID")
}

// IncUserLastID indicates an expected call of IncUserLastID
func (mr *MockUserManagerMockRecorder) IncUserLastID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IncUserLastID", reflect.TypeOf((*MockUserManager)(nil).IncUserLastID))
}
...
// IncUserLastID mocks base method
func (m *MockDBInterface) IncUserLastID() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "IncUserLastID")
}

// IncUserLastID indicates an expected call of IncUserLastID
func (mr *MockDBInterfaceMockRecorder) IncUserLastID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IncUserLastID", reflect.TypeOf((*MockDBInterface)(nil).IncUserLastID))
}
